...
docker run --rm -v sonarqube_data:/volume -v $PWD/backup:/backup alpine sh -c "rm -rf /volume/* && tar -xvf /backup/sonarqube_data.tar -C /volume"
docker run --rm -v sonarqube_logs:/volume -v $PWD/backup:/backup alpine sh -c "rm -rf /volume/* && tar -xvf /backup/sonarqube_logs.tar -C /volume"
docker run --rm -v sonarqube_extensions:/volume -v $PWD/backup:/backup alpine sh -c "rm -rf /volume/* && tar -xvf /backup/sonarqube_extensions.tar -C /volume"
...
docker compose --project-directory /jenkins --verbose up --build
